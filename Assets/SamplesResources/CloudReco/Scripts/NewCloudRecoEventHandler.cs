...
public class NewCloudRecoEventHandler : MonoBehaviour, ICloudRecoEventHandler {

	public VideoPlaybackBehaviour videoPlaybackBehaviour;
	...
	public Text cloudErrorTitle;
	public Text cloudErrorText;
	...
	void Start()
	{
		...
		trackableEventHandler = eventHandler.GetComponent<TrackableEventHandler> ();
	}
...
//			metadataText.text = targetSearchResult.MetaData;

			metadata = targetSearchResult.MetaData;

			videoPlaybackBehaviour.SetVideo (metadata);
		}
